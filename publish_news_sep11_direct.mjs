...
const publishedAt = new Date("2026-09-11T00:00:00.000Z");
...
export const articles = [
  {
    slug: "selena-gomez-encino-estate-sale-2026",
    title: "Report: Selena Gomez Sells Her Encino Estate as Beverly Hills Becomes Her Primary Base",
    summary: "Caproasia reports that Selena Gomez sold an 11,400-square-foot, six-bedroom Encino residence for $5.399 million, having bought the property for $4.9 million in 2020. The report says her primary residence is now a Beverly Hills property acquired for $35 million in 2024.",
    category: "Real Estate", source: "Caproasia",
    articleUrl: "https://www.caproasia.com/2026/09/11/united-states-billionaire-singer-selena-gomez-age-34-with-1-3-billion-fortune-sells-united-states-los-angeles-11400-sq-ft-6-bedroom-house-for-5-399-million-encino-rancho-estates-bought-for-4/",
  ...
  },
  {
    ...
    summary: "The Financial Times, republished by the Financial Post, reports that fortunes created by artificial intelligence are bringing younger, digitally native buyers into private aviation, yachting and supercars. The article says these buyers are prioritising privacy, efficiency, wellness and personalisation alongside app- and messaging-led service.",
  ...
  },
  {
    ...
    summary: "Citywealth reports that the Monaco Yacht Show will welcome 120 superyachts to Port Hercule from 23 to 26 September, including 43 new yachts launched this year. Its coverage links the show with private-client conversations around succession, property ownership and internationally mobile wealth.",
  ...
  },
  {
    ...
    summary: "BOAT International lists the 100.8-metre I Dynasty at an asking price of €240 million, leading its current ranking of the 50 most expensive yachts for sale. The roundup places Lady Lara at €230 million and the 114.2-metre Luna at €200 million, indicating continued depth in the upper brokerage market.",
  ...
  },
  {
    ...
    summary: "Foundation Source cites a study in which 88% of high-net-worth clients discussed charitable giving with advisers. The analysis argues that administrative technology can support philanthropy while adviser judgement remains central to conversations about family values and long-term impact.",
  ...
  },
  {
    ...
    summary: "Forbes reports that Virtuoso’s June luxury bookings carried an average nightly rate of $1,983, while future trips costing more than $100,000 were up 49%. The article says UHNW families are increasingly competing globally for limited suites, exclusive residences and private lodge takeovers.",
...
export function validateBatch() {
  ...
  for (const article of articles) {
    ...
    if (article.publishedAt.toISOString() !== "2026-09-11T00:00:00.000Z") throw new Error(`Invalid publication date: ${article.slug}`);
...
try {
  ...
  await appendFile("/tmp/billionaire-collection-news-upsert-2026-09-11.error.log", `${new Date().toISOString()} ${message}\n`);
