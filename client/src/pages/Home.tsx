...
const PRODUCTS = [
  { label: "Champagne", desc: "Ultra-premium cuvées from the world's most exclusive houses.", href: "/champagne", img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80" },
  { label: "Vodka", desc: "Limited-edition spirits crafted for the discerning palate.", href: "/vodka", img: "https://images.unsplash.com/photo-1569529465841-dfecdab7503b?w=600&q=80" },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 420px), 1fr))", gap: "4rem", alignItems: "center" }}>
            ...
            <FadeUp delay={0.2}>
              <div style={{ position: "relative" }}>
                <img src={LIFESTYLE_IMG} alt="Billionaire Collection lifestyle" style={{ width: "100%", aspectRatio: "4/3", objectFit: "cover" }} />
