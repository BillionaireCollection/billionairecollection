...
export default function Oud() {
  ...
  return (
    <div style={{ background: "#000" }}>
      <PageHero badge="Billionaire Oud" title="Bespoke" titleAccent="Arabian Fragrances" subtitle="The rarest oud oils and bespoke fragrances from the world's most prestigious Arabian perfumers — presented in hand-crafted crystal flacons of extraordinary beauty." image="https://images.unsplash.com/photo-1563170351-be82bc888aa4?w=800&q=80" cta={{ label: "Enquire", href: "/card-concierge" }} />
