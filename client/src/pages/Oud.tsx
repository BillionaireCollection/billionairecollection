...
export default function Oud() {
  ...
  return (
    <div style={{ background: "#000" }}>
      <PageHero badge="Billionaire Oud" title="Bespoke" titleAccent="Arabian Fragrances" subtitle="The rarest oud oils and bespoke fragrances from the world's most prestigious Arabian perfumers — presented in hand-crafted crystal flacons of extraordinary beauty." image="https://files.manuscdn.com/user_upload_by_module/session_file/310419663028447909/aTrBEiICNdtmqDta.png" cta={{ label: "Enquire", href: "/card-concierge" }} />
