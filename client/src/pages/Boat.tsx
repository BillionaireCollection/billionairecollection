...
export default function Boat() {
  ...
  "Whether you seek a 50-metre explorer yacht for Antarctic expeditions or a 100-metre floating palace for Mediterranean summers, our team of naval architects and yacht brokers will guide you to the perfect vessel."
    ...
    { title: "M/Y Solaris — 65m Benetti", sub: "Caribbean Charter", price: "$490,000/week", img: "/listing-benetti-65m-solaris.jpg", tag: "Charter" },
    { title: "M/Y Eclipse — 55m Feadship", sub: "Pacific Crossing", price: "$75,000,000", img: "/listing-feadship-55m-eclipse.webp", tag: "New Listing" }
]}
