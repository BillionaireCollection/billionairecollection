...
export default function Chrono() {
  ...
  "Transactions are conducted with absolute privacy. From acquisition to authentication, white-glove delivery, and discreet private sale — every detail is handled with the discretion that collectors of this calibre demand."
    ...
    { title: "Jacob & Co. Billionaire Series", sub: "Diamond Tourbillon — 260ct · 18k White Gold", price: "$18M–$20M+", img: "https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=800&q=80", tag: "Available" },
    { title: "Richard Mille RM 53-02", sub: "Sapphire Tourbillon — Ultra-Rare", price: "$4M–$5M+", img: "https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=800&q=80", tag: "Exclusive" }
]}
