...
export default function Cigar() {
  ...
  return (
    <div style={{ background: "#000" }}>
      <PageHero badge="Billionaire Cigars" title="Rare" titleAccent="Hand-Rolled Cigars" subtitle="The world's finest hand-rolled cigars — from aged Cuban Cohibas to rare Nicaraguan limited editions — presented in bespoke humidors of exceptional craftsmanship." image="https://files.manuscdn.com/user_upload_by_module/session_file/310419663028447909/hHzxkyIrjOXXlhoc.png" cta={{ label: "Enquire", href: "/card-concierge" }} />
