...
export default function Air() {
  ...
  "With access to over 7,000 aircraft globally and relationships with every major OEM including Gulfstream, Bombardier, Dassault, and Airbus Corporate Jets, we deliver aviation solutions that are as unique as our clients."
    ...
    { title: "Bombardier Global 7500", sub: "London to Sydney Non-Stop", price: "POA", img: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663028447909/FMfsevRbcArmLAdy.png", tag: "Charter" },
    { title: "Airbus ACJ320neo", sub: "VIP Airliner Conversion", price: "POA", img: "https://files.manuscdn.com/user_upload_by_module/session_file/310419663028447909/McqCAxeqkwWiOliR.webp", tag: "New" }
]}
