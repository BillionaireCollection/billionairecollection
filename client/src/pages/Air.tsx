...
export default function Air() {
  ...
  "With access to over 7,000 aircraft globally and relationships with every major OEM including Gulfstream, Bombardier, Dassault, and Airbus Corporate Jets, we deliver aviation solutions that are as unique as our clients."
    ...
    { title: "Bombardier Global 7500", sub: "London to Sydney Non-Stop", price: "POA", img: "https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=800&q=80", tag: "Charter" },
    { title: "Airbus ACJ320neo", sub: "VIP Airliner Conversion", price: "POA", img: "https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=800&q=80", tag: "New" }
]}
