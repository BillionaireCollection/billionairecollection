...
export const articles = [
  ...
  {
    slug: "italy-private-wealth-commercial-real-estate-deployment",
    title: "Private Wealth Investors Deploy €1.7 Billion Into Italian Commercial Property",
    summary: "Private wealth investors, family offices and family holdings deployed around €1.7 billion into Italian commercial real estate in the first half of 2026, a 15% increase from a year earlier, JLL reports. Core strategies represented 82% of activity, signalling a continued preference for resilient income and capital preservation.",
    category: "Real Estate",
    source: "JLL",
    articleUrl: "https://www.jll.com/en-us/insights/market-dynamics/italy-private-wealth",
  ...
  {
    slug: "monaco-yacht-show-2026-top-brokerage-yachts",
    title: "Monaco Yacht Show Brokerage Fleet Is Led by a €148 Million Feadship",
    summary: "YachtBuyer has identified ten headline brokerage yachts for the 2026 Monaco Yacht Show with published asking prices from €42 million to €148 million. The list is led by the 71.5-metre Feadship Vanish, underscoring the depth of ultra-prime supply heading to Port Hercule.",
    category: "Superyachts",
    source: "YachtBuyer",
    articleUrl: "https://www.yachtbuyer.com/en-us/news/the-most-expensive-yachts-for-sale-at-monaco-yacht-show-2026",
