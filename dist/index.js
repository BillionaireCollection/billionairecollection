...
// server/_core/seoMetadata.ts
var BASE_URL = "https://billionairecollection.com";
var SITE_NAME = "Billionaire Collection";
var DEFAULT_IMAGE = "https://d2xsxph8kpxj0f.cloudfront.net/310419663028447909/DwwHDtJPUge8HmugY3BgSV/bc-og-preview-M7pD3ZebBXDoyAR52uFPiQ.png";
...
var page = (title, description, keywords, aiDescription = description) => ({ title, description, keywords, aiDescription });
var PAGE_METADATA = {
  "/": page(
  ...
  "/champagne": page(
    ...
    "Billionaire Champagne, luxury champagne, premium cuv\xE9e, rare champagne, luxury products"
  ),
  "/vodka": page(
...
function pageImage(metadata) {
  return metadata.image || DEFAULT_IMAGE;
}
function pageStructuredData(pathname, metadata) {
...
function injectPageMetadata(html, pathname) {
  ...
  page2 = replaceOrAppendMeta(page2, "name", "ai-description", metadata.aiDescription);
  page2 = replaceOrAppendMeta(page2, "property", "og:type", metadata.type || "website");
  page2 = replaceOrAppendMeta(page2, "property", "og:title", title);
  page2 = replaceOrAppendMeta(page2, "property", "og:description", metadata.description);
  page2 = replaceOrAppendMeta(page2, "property", "og:url", canonical);
  page2 = replaceOrAppendMeta(page2, "property", "og:image", image);
  page2 = replaceOrAppendMeta(page2, "property", "og:image:alt", title);
  page2 = replaceOrAppendMeta(page2, "name", "twitter:card", "summary_large_image");
  page2 = replaceOrAppendMeta(page2, "name", "twitter:title", title);
  page2 = replaceOrAppendMeta(page2, "name", "twitter:description", metadata.description);
  page2 = replaceOrAppendMeta(page2, "name", "twitter:image", image);
  page2 = replaceOrAppendMeta(page2, "name", "twitter:image:alt", title);
  page2 = replaceOrAppendMeta(page2, "name", "twitter:creator", metadata.twitterCreator || "@BillionaireCol");
  ...
  page2 = existing.test(page2) ? page2.replace(existing, structuredTag) : page2.replace(/<\/head>/i, `  ${structuredTag}
</head>`);
  return page2;
}
...
function injectIndexabilityDirective(html, pathname) {
...
async function setupVite(app, server) {
  ...
  app.use("*", async (req, res, next) => {
    ...
    try {
      ...
      page2 = injectIndexabilityDirective(injectPageMetadata(injectCanonical(page2, pathname), pathname), pathname);
